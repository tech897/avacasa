...
export async function POST(request: NextRequest) {
  try {
    ...
    const propertyData = {
      ...
      unitConfiguration: data.unitConfiguration ? JSON.stringify(data.unitConfiguration) : null,
      legalApprovals: data.legalApprovals ? JSON.stringify(data.legalApprovals) : null,
      registrationCosts: data.registrationCosts ? JSON.stringify(data.registrationCosts) : null,
      propertyManagement: data.propertyManagement ? JSON.stringify(data.propertyManagement) : null,
      financialReturns: data.financialReturns ? JSON.stringify(data.financialReturns) : null,
      investmentBenefits: data.investmentBenefits ? JSON.stringify(data.investmentBenefits) : null,
      nearbyInfrastructure: data.nearbyInfrastructure ? JSON.stringify(data.nearbyInfrastructure) : null,
