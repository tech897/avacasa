...
interface PropertyFormData {
  ...
  unitConfiguration: {
    [key: string]: { area: string; price: string; availability: string };
  };
  aboutProject: string;
  legalApprovals: {
    name: string;
  ...
  const addInfrastructureItem = (category: string) => {
    setFormData((prev) => ({
      ...
      nearbyInfrastructure: {
        ...
        [category]: [
          ...(prev.nearbyInfrastructure[
            category as keyof typeof prev.nearbyInfrastructure
          ] || []),
          { name: "", distance: "", type: "" },
        ],
      },
      ...
      <form onSubmit={handleSubmit}>
        <Tabs defaultValue="basic" className="w-full text-black">
          <TabsList className="grid w-full grid-cols-6 text-black">
            <TabsTrigger value="basic" className="text-black">
              Basic Info
            </TabsTrigger>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      handleInputChange("aboutProject", e.target.value)
                    }
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={formData.area}
                      onChange={(e) =>
                        handleInputChange("area", parseInt(e.target.value))
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("floors", parseInt(e.target.value))
                      }
                    />
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {Object.entries(formData.unitConfiguration).map(
                    ([unitType, details]) => (
                      <div key={unitType} className="p-4 border rounded-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div>
                            ...
                            <select
                              aria-label="Select unit availability"
                    ...
                    <div key={index} className="p-4 border rounded-lg">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          <Label>Status</Label>
                          <select
                            aria-label="Select legal approval status"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange(
                          "registrationCosts.registrationFee",
                          e.target.value
                        )
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange(
                          "registrationCosts.legalCharges",
                          e.target.value
                        )
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange(
                          "registrationCosts.otherCharges",
                          e.target.value
                        )
                      }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange(
                          "financialReturns.appreciationRate",
                          e.target.value
                        )
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange(
                          "financialReturns.paybackPeriod",
                          e.target.value
                        )
                      }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("constructionStatus", e.target.value)
                      }
          ...
          <TabsContent value="location" className="space-y-6">
            ...
            {["educational", "healthcare", "transportation", "shopping"].map(
              (category) => (
                <Card key={category}>
                  <CardHeader>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {(
                        formData.nearbyInfrastructure[
                          category as keyof typeof formData.nearbyInfrastructure
                        ] || []
                      ).map((item, index) => (
                        <div key={index} className="p-4 border rounded-lg">
                          <div className="flex items-center justify-between mb-3">
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                removeInfrastructureItem(category, index)
                              }
                            >
                              <Trash2 className="w-4 h-4" />
                            </Button>
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                onChange={(e) => {
                                  ...
                                  const categoryItems = [
                                    ...(newInfrastructure[
                                      category as keyof typeof newInfrastructure
                                    ] || []),
                                  ];
                                  categoryItems[index] = {
                                    ...item,
                                  ...
                                  setFormData((prev) => ({
                                    ...prev,
                                    nearbyInfrastructure: newInfrastructure,
                                  }));
                                }}
