                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateSetting("emailFrom", e.target.value)
                      }
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Allow user activity tracking and analytics
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          updateSetting("moderateComments", e.target.checked)
                        }
                        className="sr-only peer"
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-gray-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-gray-900"></div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        onClick={async () => {
                          try {
                            ...
                            if (response.ok) {
                              ...
                              a.href = url;
                              a.download = `avacasa-backup-${new Date()
                                .toISOString()
                                .replace(/[:.]/g, "-")}.json`;
                          ...
                          input.onchange = async (e) => {
                            ...
                            try {
                              ...
                              if (response.ok) {
                                showMessage(
                                  "success",
                                  `Database restored successfully! Restored: ${Object.values(
                                    result.restored
                                  ).reduce(
                                    (a: any, b: any) => a + b,
                                    0
                              ...
                              showMessage(
                                "error",
                                "Failed to restore database: Invalid file or format"
                              );
                            }
                          };
                          input.click();
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          const daysToKeep = prompt(
                            "How many days of analytics data would you like to keep? (default: 30)",
                            "30"
                          );
                          ...
                          if (
                            confirm(
                              `Are you sure you want to delete analytics data older than ${days} days? This action cannot be undone.`
                            )
                          ) {
                            try {
                              showMessage(
                              ...
                              if (response.ok) {
                                showMessage(
                                  "success",
                                  `Analytics cleanup completed! Deleted ${result.totalDeleted} old records`
                                );
                              } else {
                                showMessage(
                                  "error",
                              ...
                              showMessage(
                                "error",
                                "Failed to cleanup analytics data"
                              );
                            }
                          }
                        }}
