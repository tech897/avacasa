...
import { MapPin, Search, Filter, Star, Users, Calendar, Map, Grid3X3 } from "lucide-react"
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto">
            <div className="max-w-2xl text-white">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                Holiday Homes in {location.name}
              </h1>
      ...
      {location.highlights && location.highlights.length > 0 && (
        <div className="bg-white border-b">
          <div className="container mx-auto px-4 py-8">
            <h2 className="text-2xl font-bold mb-6">What makes {location.name} special</h2>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex flex-wrap items-center gap-4">
              ...
              >
                ...
                <option value={PropertyType.FARMLAND}>Farmlands</option>
              </select>
          ...
          <div className={`${mapView ? 'lg:w-1/2' : 'w-full'} transition-all duration-300`}>
            ...
            {sortedProperties.length === 0 && (
              <div className="text-center py-16">
                ...
                <Button onClick={() => setFilters({ propertyType: undefined, priceRange: 'all', sortBy: 'featured' })}>
                  Clear Filters
                </Button>
              </div>
            )}
